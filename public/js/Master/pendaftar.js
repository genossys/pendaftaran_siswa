        ...
        success: function (response) {
            if (response.valid) {
                if (response.sqlResponse) {
                    clearField();
                    alertSukses.show().html('<p> Username ' + response.data.username + ' Berhasil Di Tambahkan </p>');
                    table.draw();
                } else {
                    alert(response.data);
                }
...
function showEditModal(username, email, nama, alamat, tglLahir, cmbJenis, namaOrtu,noHp, e) {
    e.preventDefault();
